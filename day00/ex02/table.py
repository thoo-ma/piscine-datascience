...
csv = '/home/youngbenjaminhorne/42/piscine-datascience/subject/customer/data_2022_oct.csv'
...
with engine.connect() as connection:
    ...
    # Step 1: create type
    statement = sqlalchemy.text("CREATE TYPE event_type AS ENUM ('view', 'cart', 'remove_from_cart', 'purchase');")
    ...
    for chunk in pd.read_csv(csv, chunksize=chunksize, on_bad_lines='warn', parse_dates=['event_time']):
        chunk.drop_duplicates(inplace=True) # NOTE: is it necessay at this point
